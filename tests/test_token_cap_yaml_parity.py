...
_EXPECTED_CAPS: list[tuple[str, list[int]]] = [
    ...
    ("configs/eval/muse_metrics/trajectory_metrics_minimal.yaml", [128]),
    ("configs/eval/muse_metrics/trajectory_metrics.yaml", [128]),
    ...
    ("configs/eval/muse_metrics/trajectory_all.yaml", [128, 128]),
